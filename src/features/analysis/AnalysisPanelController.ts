...
export class AnalysisPanel implements AnalysisPanelCommands {
  ...
  private readonly analysisWorker = new AnalysisWorkerClient();
  ...
  public exportReport(): void {
    ...
    download(analysisReport(this.model, this.result, this.factors, canvas?.toDataURL() ?? '', this.benchmark, ledger), 'memoria-portico.html', 'text/html;charset=utf-8');
  }
